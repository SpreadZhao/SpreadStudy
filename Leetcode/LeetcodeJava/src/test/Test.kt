...
//    }
    ...
    fun listIntersection2() {
        val node5 = ListNode(5)
        val node3 = ListNode(3, node5)
        val node2 = ListNode(2, node3)
        val node7 = ListNode(7)
        val node6 = ListNode(6, node7)
        val node4 = ListNode(4, node6)
        val node1 = ListNode(1, node4)
        println(ListIntersection().getIntersectionNode(node1, node2)?.`val`)
    }
}